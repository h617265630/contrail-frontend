...
export function getGitHubTrending(params?: {
  ...
  return request.get<TrendingResponse, TrendingResponse>('/trending/github', { params })
}
...
export function getYouTubeTrending(params: {
  ...
  return request.get<TrendingResponse, TrendingResponse>('/trending/youtube', { params })
}
...
export function getCombinedTrending(params?: {
  ...
  return request.get<CombinedTrendingResponse, CombinedTrendingResponse>('/trending/combined', { params })
}
