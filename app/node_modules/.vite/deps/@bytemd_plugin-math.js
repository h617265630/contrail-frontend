import {
  katex
} from "./chunk-ADYU6SH6.js";
import {
  patternCompile,
  safe,
  track
} from "./chunk-H7UEASIA.js";
import {
  codes,
  constants,
  factorySpace,
...
function mathToMarkdown(options) {
  ...
  function math3(node, _, context, safeOptions) {
...
// node_modules/@bytemd/plugin-math/dist/index.mjs
    ...
    viewerEffect({ markdownBody }) {
      const renderMath = async (selector, displayMode) => {
        ...
        if (els.length === 0)
          return;
        if (!katex2) {
          katex2 = await import("./katex-RV4VD7IE.js").then((m) => m.default);
        }
        els.forEach((el) => {
          katex2.render(el.innerText, el, {
            ...katexOptions,
            throwOnError: false,
            displayMode
          });
...
//# sourceMappingURL=@bytemd_plugin-math.js.map
